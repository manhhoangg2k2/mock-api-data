      ...
      <div className={dm.container}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-zinc-900/40 border border-zinc-800/80 rounded-xl p-8 flex flex-col">
            <span className="mb-4 font-sans text-base font-bold uppercase tracking-wider text-zinc-300 sm:text-base">
              Guest
            </span>
            <div className="text-3xl font-extrabold text-zinc-50 mb-6">Free</div>
            <ul className="flex-1 space-y-4 font-sans text-base leading-relaxed text-zinc-300 sm:text-base">
            ...
            <button
              ...
              className="mt-8 border border-zinc-800/70 rounded-lg text-base font-semibold text-zinc-200 py-3 hover:bg-zinc-800/40 transition-colors"
            >
              Dùng thử ngay
            </button>
          </div>
          ...
          <div className="bg-zinc-900/40 border border-violet-500/30 rounded-xl p-8 pt-16 flex flex-col relative shadow-2xl shadow-violet-500/10">
            <div className="absolute top-5 right-6 rounded-full bg-violet-500 px-3 py-1 text-base font-bold uppercase tracking-tighter text-white">
              Phổ biến nhất
            </div>
            <span className="mb-4 font-sans text-base font-bold uppercase tracking-wider text-violet-200 sm:text-base">
              Personal
            </span>
          ...
          <div className="bg-zinc-900/20 border border-zinc-800/80 rounded-xl p-8 flex flex-col opacity-70 grayscale">
            ...
            <button
              type="button"
              disabled
              className="mt-8 w-full rounded-lg bg-violet-500/20 text-zinc-400 py-3 text-base font-semibold cursor-not-allowed"
            >
              Đăng ký sớm
            </button>
          </div>
